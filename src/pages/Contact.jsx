    ...
    <div className="pt-20 min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      ...
      <section className="py-16 bg-white/80 backdrop-blur-sm">
        <div className="container mx-auto px-6 lg:px-8 text-center">
          ...
          >
            Ready to start your project? Get in touch and let's discuss how I can help bring your digital ideas to life.
          </motion.p>
        </div>
      </section>
              ...
              <div className="space-y-6">
                {[
                  ...
                  return (
                    ...
                    >
                      <div className={`w-14 h-14 bg-gradient-to-br ${color.color} rounded-xl flex items-center justify-center flex-shrink-0`}>
